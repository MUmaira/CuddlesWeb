...
import { getFirestore, setDoc, doc, getDocs, getDoc, updateDoc, collection, where, query } from "firebase/firestore";
import {
  getAuth,
  initializeAuth,
...
export { auth, db, setDoc, doc, getDocs, storage, getDoc, updateDoc, collection, where, query};
